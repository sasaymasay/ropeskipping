                ...
                <div id="header" class="group">
                    ...
                    <div class="group inner">
                        ...
                        <div id="logo" class="group">
                            <a href="/"><img src="{{ asset(env('THEME')) }}/images/logo1.png"/></a>
                        </div>
                        <!-- END LOGO -->
                        ...
                        <div id="sidebar-header" class="group">
                            ...
                            <img src="{{ asset(env('THEME')) }}/images/icons/set_icons/contact.png" alt="contact" class="icon" />
                            <h5><span style="line-height:50px; right: 0;bottom: 0;"><a href="#">Личный кабинет</a></span></h5>
                           
                        </div>
                                <blockquote class="text-quote-quote"><p><a href="/login" class="btn   btn-saltillo-2 btn-more-link">Войти</a></p></blockquote>
